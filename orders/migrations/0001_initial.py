# Generated by Django 2.2.6 on 2019-11-05 04:32
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer_address', models.CharField(blank=True, default=None, max_length=120, null=True)),
        ...
        migrations.AddField(
            model_name='order',
            name='status',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.DO_NOTHING, to='orders.OrderStatus'),
        ),
    ]
